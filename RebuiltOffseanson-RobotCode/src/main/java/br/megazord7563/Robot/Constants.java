...
public final class Constants {
  ...
  public static final class ModuleConstants {
    ...
    public static final double kWheelCircumferenceMeters =
        kWheelDiameterMeters * Math.PI; // 0.1016*3.14=

    public static final double kDriveL3 = 1 / 6.12;
    public static final double kTurningL3 = 1 / 21.42857;

    public static final double kDriveL4 = 1.0 / 5.14;
    public static final double kTurningL4 = 1.0 / 12.8;

    public static final double kDriveMotorGearRatio = 1 / kDriveL3; // 1 / 5.14; //L4 L3=1/6.12
    public static final double kTurningMotorGearRatio = 1 / kTurningL3; // 1 /12.8; // 1/18.0
    ...
    public static final double kDriveWheelFreeSpeedRps =
        (kDrivingMotorFreeSpeedRps * kWheelCircumferenceMeters) * kDriveMotorGearRatio;
    ...
    /**
     * MNL 09/11/2025 Tuner X Constants Steer Gains Ks = 0.1, Kv = 1.59, Ka = 0.0 , kp = 100.0, kD =
     * 0.5, kI = 0.0
     *
     * <p>TEste 09/23/2025 Units =Rotations Steer Ks Kv Ka Kp Kd Valor médio 0.3064025 1.602225
     * 0.01757525 64.55725 2.529675
     *
     * <p>Drive ID Ks Kv Ka Kp valor médio 0.221835 0.7482675 0.0498445 0.5347
     */

    // 14,285%
    public static final double turningKS =
        0.3064; // 0.5;//1.5;//0.1;//<-MNL 11/11/2024 0.1; //0.32; // Add 0.1 V output

    // to overcome static friction
    public static final double turningKV =
        1.602225; // 1.63;//0.12; //1.51; // A velocity target of 1 rps results in
    // 0.12 V output
    public static final double turningKA = 0.0; // 0.11; //0.27;
    public static final double kPTurning =
        64.88725; // 350.0;//100 ANTERIOR 0,5 //0,25 ; 0.2142875; 0.175; 0.125; 0.23
    public static final double kITurning = 0.0;
    public static final double kDTurning = 2.529675; // 1.0;//0.5
    ...
    public static final double driveKS =
        0.15; // 0.221835;//0.5;//1.5<-MNL 11/11/2024 0.1; //0.32; // Add 0.1 V output

    // to overcome static friction
    public static final double driveKV =
        0.73; // 0.7482675;//0.124; //1.51; // A velocity target of 1 rps results in
    // 0.12 V output
    public static final double driveKA = 0.0; // 0.27;

    // 11,69%
    public static final double kPdriving =
        0.31; // 0.1;//<--MNL11/11/2024 0.0665;//ANTERIOR 0,0665 ; 0.05872615 // kP =
    ...
    public static final int turningCurrentLimit = 70; // supply current
    public static final int turningCurrentThreshold = 120; // stator current

    public static final double turningCurrentThresholdTime = 0.1;
  ...
  public static final class DriveConstants {
    ...
    public static final double momentOfInertia =
        4.5464; // IA calculou ->4.5464 kg·m², anterior 6.88;
    ...
    //
    /**
     * MNL 17/10/2024 kFrontLeftChassisAngularOffset = 0: This means that when your front left
     * module's turning motor is at its zero position, the module is pointing straight forward
     * relative to the chassis. kFrontRightChassisAngularOffset = 0: This suggests your front right
     * module is also pointing forward when its turning motor is at zero.
     * kBackLeftChassisAngularOffset = Math.PI: This means that your back left module is pointing
     * 180 degrees from the front left module. So, when its turning motor is at zero, the module is
     * pointing straight backward relative to the chassis. kBackRightChassisAngularOffset = Math.PI:
     * This means that your back right module is also pointing straight backward when its turning
     * motor is at zero. ****
     */
    ...
    /** SINTONIA DAS RODAS FL => FRONT LEFT FR => FRONT RIGHT BL => BACK LEFT BR => BACK RIGHT */
    public static final Rotation2d angleOffsetFLTurning =
        Rotation2d.fromDegrees(30.05859375); // -4.85

    public static final Rotation2d angleOffsetFRTurning =
        Rotation2d.fromDegrees(118.212890625); // -77.43, -77.34375
    public static final Rotation2d angleOffsetBLTurning =
        Rotation2d.fromDegrees(-98.173828125); // 142.07
    public static final Rotation2d angleOffsetBRTurning =
        Rotation2d.fromDegrees(-51.591796875); // -91.14

    /*******************************************************
     * constante que limita a velocidade maxima drive teleop*
     ******************************************************/

    public static final double kPhysicalMaxSpeedMetersPerSecond = 5.2; // kRAKEN - GEAR RATIO L4
    ...
    public static final double kTeleDriveMaxSpeedMetersPerSecond =
        kPhysicalMaxSpeedMetersPerSecond; // anterior 1.052,
    // 1.175
    // 4,25531914893617
    public static final double kTeleDriveMaxAngularSpeedRadiansPerSecond =
        kPhysicalMaxAngularSpeedRadiansPerSecond / 2; // anterior
    // 2

    // Slew Rate adjustments
    public static final double kTeleDriveMaxAccelerationUnitsPerSecond =
        2.5; // anterior 2 - 2/12/2024 MNL
    ...
    public static final class FLModuleConfigs {
      int driveMotorId = kFrontLeftDriveMotorPort;
      int turningMotorId = kFrontLeftTurningMotorPort;
      int absoluteEncoderId = kFrontLeftDriveAbsoluteEncoderPort;
      Rotation2d absoluteEncoderOffset = angleOffsetFLTurning;
      double chassisAngularOffset = kFrontLeftChassisAngularOffset;
    }

    public static final class FRModuleCOnfigs {
      int driveMotorId = kFrontRightDriveMotorPort;
      int turningMotorId = kFrontRightTurningMotorPort;
      int absoluteEncoderId = kFrontRightDriveAbsoluteEncoderPort;
      Rotation2d absoluteEncoderOffset = angleOffsetFRTurning;
      double chassisAngularOffset = kFrontRightChassisAngularOffset;
    }

    public static final class BLModuleConfigs {
      int driveMotorId = kBackLeftDriveMotorPort;
      int turningMotorId = kBackLeftTurningMotorPort;
      int absoluteEncoderId = kBackLeftDriveAbsoluteEncoderPort;
      Rotation2d absoluteEncoderOffset = angleOffsetBLTurning;
      double chassisAngularOffset = kBackLeftChassisAngularOffset;
    }

    public static final class BRModuleConfigs {
      int driveMotorId = kBackRightDriveMotorPort;
      int turningMotorId = kBackRightTurningMotorPort;
      int absoluteEncoderId = kBackRightDriveAbsoluteEncoderPort;
      Rotation2d absoluteEncoderOffset = angleOffsetBRTurning;
      double chassisAngularOffset = kBackRightChassisAngularOffset;
    }
    ...
    public enum LedMode {
      ...
      BLACK,
      PINK,
      WHITE // Extremely slow speed for alignment or lifting
    }
  }
  ...
  public static final class AutoConstants {
    public static final double kMaxSpeedMetersPerSecond =
        DriveConstants.kPhysicalMaxSpeedMetersPerSecond / 5.0; // 4
    public static final double kMaxAngularSpeedRadiansPerSecond =
        DriveConstants.kPhysicalMaxAngularSpeedRadiansPerSecond / 2; // div/2//10,20
  ...
  public static final class PathPlannerConstants {
    public static final double kPTranslationPath = 5.0; // 3.5 Anterior 0.125,10
    public static final double kITranslationPath = 0.0;
    public static final double kDTranslationPath = 0.0;

    public static final double kPRotationPath = 2.0; // 2.0, 3.0; //3.0; 1.6
    public static final double kIRotationPath = 0.0;
    public static final double kDRotationPath = 0.0001;

    public static final PIDConstants kPIDRotationPath =
        new PIDConstants(kPRotationPath, kIRotationPath, kDRotationPath);
    public static final PIDConstants kPIDTranslationPath =
        new PIDConstants(kPTranslationPath, kITranslationPath, kDTranslationPath);

    public static final PPHolonomicDriveController AutoConfig =
        new PPHolonomicDriveController(kPIDTranslationPath, kPIDRotationPath);
    ...
    public static RobotConfig robotConfig =
        new RobotConfig(
            DriveConstants.totalMassKg, // The mass of the robot,
            ...
            new ModuleConfig(
                ...
                DCMotor.getKrakenX60(1).withReduction(DriveConstants.driveGearRatio),
